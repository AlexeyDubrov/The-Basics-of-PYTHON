...
class Road:
    ...
    def consumption(self):
        self.weigth = 25
        self.thick = 0.05
        consumption = self._length * self._width * self.weigth * self.thick
        print(f'Необходимо {consumption} тонн асфальта для строительства дороги')

road_to_village = Road(20, 5000)
road_to_village.consumption()
